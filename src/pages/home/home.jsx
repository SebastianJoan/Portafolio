            ...
            <main>
                ...
                <div className='w-full h-auto p-8 py-4 gap-5 bg-gray-800 font-mono flex flex-col md:flex-row justify-center items-center justify-items-center'>
                    ...
                    <div className='md:w-[85%] w-full'>
                        <div className='w-full h-auto bg-black text-center  font-mono rounded-t-lg px-4 py-1 text-white'>
                            C/Windows/System32/cmd.exe
                        </div>
                        <div className='bg-black p-4 rounded-b-lg'>
                            <p className='animate-typing animate-duration-500 font-mono text-white'>
                                C:\Users\visit: {text}
                            </p>
                        </div>
                    </div>
                ...
                <div className='w-full h-auto bg-gray-800 px-4 py-2'>
                    <div className='md:w-[100%] w-full'>
                        <div className='w-full h-auto bg-black text-center rounded-t-lg font-mono md:px-4 py-1 text-white'>
